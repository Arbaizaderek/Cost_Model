...
namespace Cost_Model.Views
{
    public partial class HogarCrud : Form
    {
        ...
        void InsertHogar()
        {
            ...
            hogar.InsertHogar(name, GetSubModality(), GetRegion(), f1, f2, f3, f4, GetGender(), infra, edu, hea, rec, fed, hig, ves, dia, dir, equ, all, vid, adm);
            EnlistHogar();
            Clean();
        }
        void UpdateHogar()
        {
            ...
            hogar.UpdateHogar(Convert.ToInt32(dataGridViewIntervencion.CurrentRow.Cells[0].Value), name, GetSubModality(), GetRegion(), f1, f2, f3, f4, GetGender(), infra, edu, hea, rec, fed, hig, ves, dia, dir, equ, all, vid, adm);
            EnlistHogar();
            Clean();
        }
