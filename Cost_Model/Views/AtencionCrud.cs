...
namespace Cost_Model.Views
{
    public partial class AtencionCrud : Form
    {
        ...
        void EnlistCentro()
        {
            dataGridViewIntervencion.DataSource = centro.EnlistCentro();
        }
        bool Validations()
        {
        ...
        void InsertCentro()
        {
            ...
            centro.InsertCentro(name, GetSubModality(), GetRegion(), f1, f2, f3, f4, GetGender(), infra, edu, hea, rec, fed, hig, ves, dia, dir, equ, all, vid, adm);
            EnlistCentro();
            Clean();
        }
        ...
        void UpdateCentro()
        {
            ...
            centro.UpdateCentro(Convert.ToInt32(dataGridViewIntervencion.CurrentRow.Cells[0].Value), name, GetSubModality(), GetRegion(), f1, f2, f3, f4, GetGender(), infra, edu, hea, rec, fed, hig, ves, dia, dir, equ, all, vid, adm);
            EnlistCentro();
            Clean();
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                dataGridViewIntervencion.DataSource = centro.SearchCentro(txtSearch.Text);
            }
        }
    }
}
