...
namespace Cost_Model.Views
{
    public partial class IntervencionCrud : Form
    {
        ...
        void EnlistIntervencion()
        {
            dataGridViewIntervencion.DataSource = intervencion.EnlistIntervencion();
        }
        bool Validations()
        {
        ...
        void InsertIntervencion()
        {
            ...
            intervencion.InsertIntervencion(name, GetSubModality(), GetRegion(), f1, f2, f3, f4, GetGender(), infra, edu, hea, rec, fed, hig, ves, dia, dir, equ, all, vid, adm);
            EnlistIntervencion();
            Clean();
        }
        void Clean()
        ...
        void UpdateIntervencion()
        {
            ...
            intervencion.UpdateIntervencion(Convert.ToInt32(dataGridViewIntervencion.CurrentRow.Cells[0].Value), name, GetSubModality(), GetRegion(), f1, f2, f3, f4, GetGender(), infra, edu, hea, rec, fed, hig, ves, dia, dir, equ, all, vid, adm);
            EnlistIntervencion();
            Clean();
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                dataGridViewIntervencion.DataSource = intervencion.SearchIntervencion(txtSearch.Text);
            }
        }
    }
}
