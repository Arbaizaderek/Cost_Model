...
namespace Cost_Model.Views
{
    public partial class ShelterCrud : Form
    {
        ...
        private void ShelterCrud_Load(object sender, EventArgs e)
        {

        }
        void EnlistAlbergue()
        {
            dataGridViewUnity.DataSource = albergue.EnlistAlbergue();
        }
        void InsertAlbergue()
        {
        ...
        int GetSubModality()
        {
            return Convert.ToInt32(comboBoxSubmodality.SelectedIndex + 1);
        }
        int GetRegion()
        {
        ...
        private void dataGridViewUnity_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtName.Text = dataGridViewUnity.CurrentRow.Cells[1].Value.ToString();
            comboBoxSubmodality.SelectedItem = dataGridViewUnity.CurrentRow.Cells[2].Value.ToString();
            comboBoxRegion.SelectedItem = dataGridViewUnity.CurrentRow.Cells[3].Value.ToString();
            numericUpDownF04.Value = Convert.ToInt32(dataGridViewUnity.CurrentRow.Cells[4].Value);
            numericUpDownF56.Value = Convert.ToInt32(dataGridViewUnity.CurrentRow.Cells[5].Value);
            numericUpDownF712.Value = Convert.ToInt32(dataGridViewUnity.CurrentRow.Cells[6].Value);
            numericUpDownF1318.Value = Convert.ToInt32(dataGridViewUnity.CurrentRow.Cells[7].Value);
            comboBoxgGender.SelectedItem = dataGridViewUnity.CurrentRow.Cells[8].Value.ToString();
            if(dataGridViewUnity.CurrentRow.Cells[9].Value.ToString() != "Información no disponible")
            {
                txtInfra.Text = dataGridViewUnity.CurrentRow.Cells[9].Value.ToString();
            }
            if (dataGridViewUnity.CurrentRow.Cells[10].Value.ToString() != "Información no disponible")
            {
                txtEdu.Text = dataGridViewUnity.CurrentRow.Cells[10].Value.ToString();
            }
            if (dataGridViewUnity.CurrentRow.Cells[11].Value.ToString() != "Información no disponible")
            {
                txtSalu.Text = dataGridViewUnity.CurrentRow.Cells[11].Value.ToString();
            }
            if (dataGridViewUnity.CurrentRow.Cells[12].Value.ToString() != "Información no disponible")
            {
                txtRecre.Text = dataGridViewUnity.CurrentRow.Cells[12].Value.ToString();
            }
            if (dataGridViewUnity.CurrentRow.Cells[13].Value.ToString() != "Información no disponible")
            {
                txtAlime.Text = dataGridViewUnity.CurrentRow.Cells[13].Value.ToString();
            }
            if (dataGridViewUnity.CurrentRow.Cells[14].Value.ToString() != "Información no disponible")
            {
                txtHigiene.Text = dataGridViewUnity.CurrentRow.Cells[14].Value.ToString();
            }
            if (dataGridViewUnity.CurrentRow.Cells[15].Value.ToString() != "Información no disponible")
            {
                txtVestuario.Text = dataGridViewUnity.CurrentRow.Cells[15].Value.ToString();
            }
            if (dataGridViewUnity.CurrentRow.Cells[16].Value.ToString() != "Información no disponible")
            {
                txtCuidado.Text = dataGridViewUnity.CurrentRow.Cells[16].Value.ToString();
            }
            if (dataGridViewUnity.CurrentRow.Cells[17].Value.ToString() != "Información no disponible")
            {
                txtAten.Text = dataGridViewUnity.CurrentRow.Cells[17].Value.ToString();
            }
            if (dataGridViewUnity.CurrentRow.Cells[18].Value.ToString() != "Información no disponible")
            {
                txtCompra.Text = dataGridViewUnity.CurrentRow.Cells[18].Value.ToString();
            }
            if (dataGridViewUnity.CurrentRow.Cells[19].Value.ToString() != "Información no disponible")
            {
                textBoxMesad.Text = dataGridViewUnity.CurrentRow.Cells[19].Value.ToString();
            }
            if (dataGridViewUnity.CurrentRow.Cells[20].Value.ToString() != "Información no disponible")
            {
                txtProye.Text = dataGridViewUnity.CurrentRow.Cells[20].Value.ToString();
            }
            if (dataGridViewUnity.CurrentRow.Cells[21].Value.ToString() != "Información no disponible")
            {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            if(txtSearch.Text == "")
            {
                MessageBox.Show("Ingrese que desea buscar", "Busqueda", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
